import './AsideLBlog.css';

export default function createAsideLBlog(key) {
	return (
		<div>
			<div className="sideIcons">
				<button className="btnIcon spacing" title="Heart">
					<span>
						<svg
				...
				<span id="reaction1" className="FGray FS12">
					5
				</span>
			</div>

			<div className="sideIcons">
				<button className="btnIcon" title="Unicorn">
					<span>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
				...
				<span id="reaction2" className="FGray FS12">
					17
				</span>
			</div>

			<div className="sideIcons">
				<button className="btnIcon" title="Save">
					<span>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
				...
				<span id="reaction3" className="FGray FS12">
					21
				</span>
			</div>

			<div className="sideIcons">
				<button className="btnIcon" title="Heart">
					<span>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
							height="24"
							role="img"
							aria-labelledby="aas5rrusxkmbhdscdkeiwdzcmbz5j3ab"
							aria-hidden="true"
							className="crayons-icon d		dropdown-icon"
						>
							<title id="aas5rrusxkmbhdscdkeiwdzcmbz5j3ab">More...</title>
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
